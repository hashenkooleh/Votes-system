  ...
  setTimeout(function() {
    $('#result').click(function() {
      ...
      $('#doughnutChart').drawDoughnutChart([
        {
          title: 'Nick',
          value: parseInt($('#table>tr:nth-child(1)>td:nth-child(2)').text()),
          color: '#2C3E50',
        },
        {
          title: 'Edward',
          value: parseInt($('#table>tr:nth-child(2)>td:nth-child(2)').text()),
          color: '#FC4349',
        },
        {
          title: 'John',
          value: parseInt($('#table>tr:nth-child(3)>td:nth-child(2)').text()),
          color: '#6DBCDB',
        },
      ]);
    });
...
(function($, undefined) {
  $.fn.drawDoughnutChart = function(data, options) {
    ...
    var $summaryTitle = $(
      '<p class="' + settings.summaryTitleClass + '">' + settings.summaryTitle + '</p>'
    ).appendTo($summary);
    var $summaryNumber = $('<p class="' + settings.summaryNumberClass + '"></p>')
      .appendTo($summary)
      .css({ opacity: 0 });
    ...
    function pathMouseEnter(e) {
      ...
      $tip
        .text(data[order].title + ':' + ((data[order].value * 100) / segmentTotal).toFixed(2) + '%')
        .fadeIn(200);
    ...
    function drawPieSegments(animationDecimal) {
      ...
      if (
        data.length === 1 &&
        4.7122 < rotateAnimation * ((data[0].value / segmentTotal) * (PI * 2)) + startRadius
      ) {
